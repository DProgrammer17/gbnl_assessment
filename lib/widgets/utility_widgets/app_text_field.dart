...
import 'package:great_brands_assessment/utils/textfeild_formatter/amount_formatter.dart';
import 'package:great_brands_assessment/widgets/utility_widgets/keyboard_overlay.dart';
...
class _AppTextfieldState extends State<AppTextfield> {
  ...
  Widget build(BuildContext context) {
    inputBorder = OutlineInputBorder(
      borderRadius: BorderRadius.circular(widget.borderRadius ?? 0.ar),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                bottom: BorderSide(
                  color: AppColors.textFieldGrey2
                )
              )
            ),
            child: TextFormField(
              ...
              decoration: InputDecoration(
                contentPadding: widget.contentPadding ?? EdgeInsets.symmetric(vertical: 4.ah),
